...
import requests
from config.config import PRIMARY_COLOR, SECONDARY_COLOR

def get_github_stars():
    try:
        response = requests.get("https://github.com/RakeshBhol/HealthAIUsingGenAI")
    ...
    st.markdown(
        ...
        <div style='{base_styles}'>
            <p style='
                ...
                gap: 8px;'>
            <a href='https://github.com/RakeshBhol/HealthAIUsingGenAI'
                target='_blank' 
                style='
                    color: #64B5F6;
